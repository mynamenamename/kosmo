	...
	public static void main(String[] args) {
		...
		System.out.println(str1);
 		System.out.println(str2);
 		  ...
 		  //substring ()      //글자를 잘라서 출력 (0,5) , 0포함 5미포함
 		System.out.println(str1.substring(0,5));   //index 0 ~ index 5 **전**까지 잘라라
 		       //Java
 	    System.out.println(str1.substring(3,8));  //3은 포함, 8은 미포함
               //a Stu	        
 	    System.out.println(str1.substring(5));   //index 5 부터 뒤로 모두 자름
               //Study
 	    
 	      //split()          //특정 문자를 기준으로 잘라서 배열에 저장  <<중요 ㅋ
 	    ...
 	    System.out.println(Arrays.toString(strArr1));
 	      ...
 	      //공백을 기준으로 모두 잘라서 배열에 저장 후 출력: for, Enhanced, Arrays.toString
 	    ...
 	    String str3 = new String ("Java");  //대
 	    String str4 = new String ("Java");  //대
 	    String str5 = new String ("java");  //소
		...
		System.out.println("====================");
 	    ...
 	    System.out.println(str4.equals(str5));  //false
 	       //equalsIgnoreCase() : 대소문자를 구분하지 말고 값을 비교
