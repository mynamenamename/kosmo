...
public class Using_String05 {
	...
	public static void main(String[] args) {
          ...
          * 1. 수정이 불가하다. => 새로운 값을 Heap 영역에서 생성 
		...
		// 2-2 indexOf() : 해당 글자에 대한 방번호 출력, 왼쪽(처음) >> 오른쪽(끝)
		//     lastIndexOf() : 해당 글자에 대한 방번호 출력, 오른쪽(끝) >> 왼쪽(처음)
		...
		String str3 = String.valueOf(2.3);            //doble >> String
