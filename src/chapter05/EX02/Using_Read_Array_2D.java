	...
	public static void main(String[] args) {
          // 2차원 배열의 값을 읽기 ****헷갈림! 주의~!
		   ...
		   System.out.println(arr1.length);    // 2 <== 행의 갯수
 		   ...
 		   System.out.println("=====이중for문을 사용해서 이차원 배열값 출력=====");
 		   ...
 		   // 3. Enhanced for문을 사용해서 출력 : 이중for문을 사용해서 출력
 		     // 바깥쪽 for문 : 
 		    System.out.println("=====Enhanced for문으로 출력=====");
 		     for (int[] a : arr2) {     //arr2 2차원배열을 1차원 배열로 꺼낸다.
 		    	 for (int b : a) {      //a는 1차원 배열// a의 각방의 값을 b 변수로 꺼낸다.
 		    		 System.out.print(b + " ");
 		    	 }
 		    	 System.out.println();
 		     }
