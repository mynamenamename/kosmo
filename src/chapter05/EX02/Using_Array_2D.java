...
public class Using_Array_2D {
	...
	public static void main(String[] args) {
		...
		System.out.print(arr1[0][3]+ " " + arr1[0][4]);
		System.out.println();
		...
		System.out.println(arr1[0].length); //5 <== 0번행의 열의 갯수
		System.out.println(arr1[1].length); //2 <== 1번행의 열의 갯수
		System.out.println(arr1[2].length); //3 <== 2번행의 열의 갯수
		System.out.println(arr1[3].length); //2 <== 4번행의 열의 갯수
		System.out.println("===========================");
