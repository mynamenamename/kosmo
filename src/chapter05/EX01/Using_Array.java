...
public class Using_Array {
	...
	public static void main(String[] args) {
		  ...
		  //배열 a 변수의 방의 크기 5개를 생성 후 주소값을 a에 할당해라 
		  //방번호 [index] 0 ~ 4 방까지 Heap 영역에 생성됨 //무족권 0부터 시작!!
		  ...
		  //for문을 사용해서 출력 : 보통 이렇게 출력함
		  System.out.println("=====for문을 사용해서 배열 방의 값을 출력=====");
		  for (int i = 0; i < 5 ; i ++) {
			  System.out.println(a[i]);
		  }
		  
		  System.out.println("배열변수 a에 방의 갯수:" + a.length);         //배열 방의 총 갯수를 출력
