...
//  클래스 : 객체를 만들기 위한 툴, 설계도
        // 필드    : 클래스 블락에서 선언된 변수 (멤버변수)
        // 생성자
        // 메소드   : 메소드 내부에 선언된 변수 (지역변수)
        // 이너클래스
//  객체 (인스턴스)  : 클래스를 틀로해서 만들어진 RAM에 로드된 객체, 건물 
...
class A{
	...
	//기본생성자 : 클래스이름과 동일한 메소드를 생성자, 리턴타입이 없다.
...
public class Using_Class02 {
	...
	//======================================================
		...
		System.out.println("====A class를 틀로해서 객체 무한정 생성가능====");
		A c = new A();
