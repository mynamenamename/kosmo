...
public class ConsoleOutPut03 {
   public static void main(String[] args) {
	   ...
	   System.out.println("당신의 나이는 " + d + "살 이고, 오늘은 " + e +  
	    		"이고, 당신은 " + f + "입니다."
	    		);
	   System.out.printf("당신의 나이는 %d살 이고, 오늘은 %s이고, 당신은 %s입니다.",
			      d, e, f );
	   ...
	   System.out.println(i+ "는 평균나이가 "+ g + "살이 될 것입니다. 평균적으로 "
	   + h + "에 많이 태어났습니다.");
	   
	   System.out.printf("%s는 평균나이가 %d살이 될 것입니다. 평균적으로 %s에 많이 태어났습니다.",
			  i, g, h );
