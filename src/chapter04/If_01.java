...
public class If_01 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("=========조건이 true=========");
		 ...
		 if (3 < 5) {    //조건이 true 이므로 실행문 내의 구문은 실행된돠~!
		    	System.out.println("안녕");
		    	System.out.println("방가");
		 }
		 
		 //if 조건에서 실행문이 1개일때는 중괄호를 생략할 수 있음.  (주의요함)
		 //권장사항: ~웬만하면 붙이기 . 중괄호 명시 후 사용~!
		 System.out.println("==================");
    	 if (5 < 3) 
    		 System.out.println("오늘은 비가 옵니다.");	  //중괄호 생략 ~ 한개만 됨
	...
	//	 System.out.println(a);       //변수의 값을 넣지 않고 출력
		...
		if (c >= 90) {                            //false
			...
			System.out.println("B학점입니다.");      //실행문 실행 후 if문 빠져나감!
		}else if(c >= 70) {
