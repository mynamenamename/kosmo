...
class Person {
	// class : 객체를 생성하기 위한 탬플릿(틀), 붕어빵기계 , 설계도
	// Object(객체, 인스턴스) : 붕어빵, 건축물 <= instance화
	...
	// 2. 생성자 (Constructor) : 1.리턴타입이 없다. , 2. 클래스이름과 동일해야 한다.(메소드)
	// 필드의 기본값을 초기화
	...
	// 3. 메소드(함수) : 기능을 실행하는 코드를 저장, 호출시 작동, 메소드명();
...
public class Using_Object_Review {
	...
	public static void main(String[] args) {
		...
		System.out.println(person.weight);
		  ...
		  //getter를 사용해서 필드 내용을 출력 ( 필드의 값을 리턴 ) 
	    ...
	    System.out.println(person.getWeight());
	     ...
	     //show()를 사용해서 필드 내용을 출력
	    System.out.println("====show() method를 사용해서 출력====");
	    person.show();
